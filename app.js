...
function cadastrarDespesa(){
    ...
    if(despesa.validarDados()){
        ...
        document.getElementById('modalTitulo').innerHTML = 'Erro na inclusao do registro'
...
function carregaListaDespesas(despesas = Array(), filtro = false){
    ...
    //percorrer o array despesas, lista cada despesa de forma dinamica
    despesas.forEach(function(d){
        ...
        btn.innerHTML = '<i class="bi bi-archive-fill"></i>'
